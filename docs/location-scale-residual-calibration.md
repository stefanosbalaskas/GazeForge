...
GazeForge provides deterministic **simulation-calibrated residual diagnostics** for the three currently certified location-scale model families:

- `HierarchicalLocationScaleResult`, with independent participant location and log-scale random intercepts;
- `CorrelatedLocationScaleResult`, with an estimated participant location/log-scale random-effect correlation; and
