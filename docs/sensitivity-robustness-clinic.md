...
- [Missing-data assumptions & treatment handoff](missing-data-assumptions.md) — document mechanism assumptions and candidate treatment families before executing missing-data sensitivity variants.
