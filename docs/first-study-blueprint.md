...
Use the [Research evidence bundle](research-evidence-bundle.md) to see this separation implemented as one runnable archive, the [Artifact & output dictionary](artifact-dictionary.md) to interpret each file, then the [Reporting & interpretation clinic](reporting-interpretation-clinic.md), [Publication readiness](publication-readiness.md), [Validation reporting cookbook](validation-reporting-cookbook.md), and [Reproducible reporting](reproducible-reporting.md) before manuscript submission.
