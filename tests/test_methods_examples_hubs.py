...
def test_examples_gallery_covers_all_real_scripts_and_exact_commands() -> None:
    ...
    scripts = (
        ...
        "13_worked_reviewer_replication_bundle.py",
    )
    ...
    assert "python examples/13_worked_reviewer_replication_bundle.py" in page
...
def test_new_hubs_are_discoverable_without_expanding_homepage_hero() -> None:
    ...
    assert "13_worked_reviewer_replication_bundle.py" in examples_readme
